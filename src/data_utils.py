...
"""
Adjusts target labels so that the sought after class has output label 1
and every other item shares the same label of -1
"""
def construct_one_vs_all(input, output, primary_target):
    output[output != primary_target] = -1
    output[output == primary_target] = 1
    return input, output
